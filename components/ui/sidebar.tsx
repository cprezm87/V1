...
export function SidebarRail_old({ className, ...props }: SidebarRailProps) {
  ...
  return (
    <div
      className={cn(
        "fixed inset-y-0 left-0 z-40 w-16 bg-sidebar-accent/10 border-r border-sidebar-border flex flex-col items-center py-4",
        isOpen ? "hidden" : "block",
        className,
      )}
      {...props}
    >
      ...
      >
        <svg
          ...
          className="h-6 w-6 text-sidebar-accent"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
